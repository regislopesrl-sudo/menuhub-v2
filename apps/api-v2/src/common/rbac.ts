...
export const TENANT_PERMISSIONS = {
  ...
  DELIVERY_ZONES_PRICING: 'delivery_zones.pricing',
  DELIVERY_ZONES_SCHEDULE: 'delivery_zones.schedule',
  DELIVERY_ZONES_AUDIT: 'delivery_zones.audit',
  ...
  PURCHASES_QUOTES_READ: 'purchases.quotes.read',
  PURCHASES_QUOTES_MANAGE: 'purchases.quotes.manage',
  SUPPLIERS_READ: 'suppliers.read',
  SUPPLIERS_MANAGE: 'suppliers.manage',
  RECIPE_COST_READ: 'recipe.cost.read',
  RECIPE_COST_MANAGE: 'recipe.cost.manage',
  ...
  REPORTS_WAITER: 'reports.waiter',
  REPORTS_OPERATOR: 'reports.operator',
